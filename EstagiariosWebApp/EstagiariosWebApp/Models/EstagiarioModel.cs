...

{
    ...
    {
        public static List<EstagiarioModel> estagiariosLista = new List<EstagiarioModel>();
        ...
        public static implicit operator string (EstagiarioModel estagiario)
        ...
        public static implicit operator EstagiarioModel (string line)
        {
            var data = line.Split(separator: ",");

            return new EstagiarioModel(
                data[0],
                int.Parse(data[1]),
                data[2],
                data[3].ToDateTime(),
